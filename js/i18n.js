(() => {
  ...
  const dict = {
    fr: {
      ...
      "demos.card1.desc": "Fini les feuilles de présence papier : chaque employé pointe en un scan, dépose ses demandes de congé ou d'avance depuis son téléphone, et la paie se calcule automatiquement en fin de mois — déployé sur plusieurs sites, pour plusieurs entreprises.",
      ...
      "demos.card3.title": "Gestion de restaurant — CookAfrica",
      ...
      "contact.location.value": "Abidjan, Côte d'Ivoire — interventions dans toute l'Afrique de l'Ouest",
    ...
    en: {
      ...
      "demos.card1.desc": "No more paper sign-in sheets: employees clock in with a scan, submit leave or advance requests from their phone, and payroll calculates itself at month-end — running across multiple sites, for multiple companies.",
      ...
      "demos.card3.title": "Restaurant management — CookAfrica",
      ...
      "contact.location.value": "Abidjan, Côte d'Ivoire — working across West Africa",
